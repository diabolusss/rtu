...
interface
   ...
   procedure setWindow(xs,ys,dx,dy,bodyClr,fontClr:byte);

implementation uses crt,dos,ld5io,ld5preDefined;
  ...
  procedure footer(mode:byte);
   BEGIN 
    ...
    case mode of 
     ...
     4:write('ArrowUp-Up ArrowDn-Down Enter-Accept Esc-Exit');
     end;
   ...
   procedure setWindow(xs,ys,dx,dy,bodyClr,fontClr:byte);
    ...
    BEGIN
     xb:=dx+xs+1;yb:=ys+dy;
     window(xs,ys,xb,yb);textbackground(bodyClr);clrscr;textcolor(fontClr);
    END;
